...
def get_compInfo(comp):
    r = requests.get('search/all/{}'.format(comp),headers=afterLogin_headers)
    r.raise_for_status()
...
if __name__ == '__main__':
    import pickle
    with open('C:/Users/chen/Desktop/IPO_info/saved_config/zb_zxb_stocksInfo.pkl', 'rb') as file:
        ...
        for i, (k, v) in enumerate(all_data.items()):
            ...
            if j > 60:
                break
    with open('C:/Users/chen/Desktop/IPO_info/saved_config/zb_zxb_stocksInfo.pkl', 'wb') as file:
