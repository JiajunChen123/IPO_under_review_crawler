...
def get_meetingData():
    ...
    df.to_csv('C:/Users/chen/Desktop/IPO_info/EastMoney/easymoney_data_meeting.csv'.format(i),index=False,encoding='utf-8-sig')
...
def eastmoney_cleanUP():
    east_money=  pd.read_csv('C:/Users/chen/Desktop/IPO_info/EastMoney/easymoney_data.csv')
    east_money.replace({'是否提交财务自查报告':' '},'是')M
