...
def data_process(raw_data):
    ...
    if 'prjid' in raw_data:
        ...
        directory = os.getcwd() + '/data/IPO/创业板/' + cleaned_data['baseInfo']['projType'] +'/' +cleaned_data['baseInfo']['cmpName'] 
        save_pickle(cleaned_data, directory + '/' + 'clean_info.pkl')
    else:
        cleaned_data = sh_process(raw_data)
        directory = os.getcwd() + '/data/IPO/科创板/' + cleaned_data['baseInfo']['projType'] +'/' +cleaned_data['baseInfo']['cmpName'] 
        save_pickle(cleaned_data, directory + '/' + 'clean_info.pkl')
    return cleaned_data
