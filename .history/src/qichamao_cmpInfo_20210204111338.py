...
afterLogin_headers = {
    'Cookie':
    'qznewsite.uid=y4eseo3a1q4xbrwimor3o5tm; qz.newsite=; Hm_lvt_55ad112b0079dd9ab00429af7113d5e3=1611805092,1612262918; Hm_lpvt_55ad112b0079dd9ab00429af7113d5e3=1612262927',
    'Referer':
...
def get_compInfo(comp):
    # 输入公司名称，返回公司基本公司信息
    r = requests.get('{}/search/all/{}'.format(base_url, comp),
                     headers=afterLogin_headers)
    r.raise_for_status()
    ...
    info = soup2.find(attrs={
        'class': 'qd-table-body li-half f14'
    }).findAll('div')
