...
def data_getter(stockAidotNum, projtype):
    ...
    save_pickle(stock_allInfo, directory + '\\' + 'info')
...
def index_getter(projtype):
    ...
    save_obj(index_list, os.getcwd() + '\\' + 'shkcb_index'+'_'+projtype)
    return index_list
...
if __name__ == '__main__':
    ...
    i = 0
    proj_list = load_obj('C:/Users/chen/Desktop/IPO_info/shkcb_index')
