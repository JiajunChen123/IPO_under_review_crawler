...
if __name__ == '__main__':
    import pickle
    with open('C:/Users/chen/Desktop/IPO_info/zb_zxb_info.pkl', 'rb') as file:
    ...
    with open('C:/Users/chen/Desktop/IPO_info/csrc.pkl', 'rb') as file:
        pickle.dump(csrc_dict, f, pickle.HIGHEST_PROTOCOL)