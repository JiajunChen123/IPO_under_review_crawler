...
def save_pick(obj, directory, filename):
...
def to_dataframe(allStock_info):
    dd = []
    # directory = os.getcwd()+'/' + 'allStock_info.pkl'
    # allStock_info = load_pickle(directory)
    idx = 0
...
def to_html(allStock_info):
    ...
    df.to_html(os.getcwd()+'/index.html',border=1,render_links=True,escape=False,index=True)
