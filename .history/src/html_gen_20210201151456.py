...
def gen_html(data):
    ...
    if data['baseInfo']['auditMarket'] == '上交所':
        saved_path = os.getcwd() + '/data/IPO/科创板/'+ data['baseInfo']['projType'] + '/'+ data['baseInfo']['cmpName']+ '/' + data['baseInfo']['cmpName'] +'.html'
    else:
        saved_path = os.getcwd() + '/data/IPO/创业板/'+ data['baseInfo']['projType'] + '/'+ data['baseInfo']['cmpName']+ '/' + data['baseInfo']['cmpName'] +'.html'
