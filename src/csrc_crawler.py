...
# -*- encoding: utf-8 -*-
'''
@File    :   main_IPO_crawler.py
@Time    :   2021/02/04 14:11:57
@Author  :   Jiajun Chen 
@Version :   1.0
...
if __name__ == '__main__':
    ...
    for i in date:
        ...
        Process(i,sh_base_url,sh_data_list)

    with open('C:/Users/chen/Desktop/IPO_info/szIPO' + '.pkl', 'wb') as f:
        pickle.dump(sz_data_list, f, pickle.HIGHEST_PROTOCOL)

    with open('C:/Users/chen/Desktop/IPO_info/shIPO' + '.pkl', 'wb') as f:
            pickle.dump(sh_data_list, f, pickle.HIGHEST_PROTOCOL)